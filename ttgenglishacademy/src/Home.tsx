...
import {
    ...
    ChevronDown, Mail, MapPin, GraduationCap
} from 'lucide-react'
...
const Home: React.FC = () => {
    ...
    const handleMouseLeave = () => {
        closeTimer = setTimeout(() => {
            setDropdownOpen(false)   // close after 150ms delay
        }, 150)
    }
    ...
    return (
        <div className="min-h-screen bg-white font-sans scroll-smooth">
            ...
            {/* NAVBAR */}
            <nav className="bg-blue-900 text-white px-8 py-4 flex justify-between items-center shadow-lg sticky top-0 z-50">
            ...
            {/* HERO */}
            <section id="hero" className="bg-gradient-to-br from-blue-900 to-blue-700 text-white py-28 px-6 text-center">
                ...
                <div className="flex justify-center gap-4 flex-wrap">
                    <a href="/register" className="bg-yellow-400 text-blue-900 font-bold px-8 py-3 rounded-full text-lg hover:bg-yellow-300 transition shadow-lg">Get Started Free</a>
                    <a href="/packages" className="border-2 border-white text-white font-bold px-8 py-3 rounded-full text-lg hover:bg-white hover:text-blue-900 transition">View Packages</a>
                </div>
            </section>

            {/* WHAT WE OFFER */}
            <section id="offer" className="py-20 px-6 bg-gray-50">
                <div className="text-center mb-14">
                    <h2 className="text-3xl font-extrabold text-blue-900 mb-3">Everything You Need To Succeed</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                        ...
                        <h3 className="text-lg font-bold text-blue-900 mb-2">Courses and Lessons</h3>
                        <p className="text-gray-500 text-sm">Structured PDF lessons and assignments that guide you from beginner to confident English teacher.</p>
                    </div>
                    <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                        <div className="flex justify-center mb-4">
                            <div className="bg-blue-100 p-4 rounded-full">
                        ...
                        <h3 className="text-lg font-bold text-blue-900 mb-2">Job Board</h3>
                        <p className="text-gray-500 text-sm">Find real English teaching jobs on platforms like VIPKid, iTalki, Preply and more.</p>
                    </div>
                    <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                        <div className="flex justify-center mb-4">
                            <div className="bg-blue-100 p-4 rounded-full">
                        ...
                        <h3 className="text-lg font-bold text-blue-900 mb-2">Certifications</h3>
                        <p className="text-gray-500 text-sm">Discover TEFL, CELTA and other certifications that will make you stand out as an English teacher.</p>
                    </div>
                    <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                        <div className="flex justify-center mb-4">
                            <div className="bg-blue-100 p-4 rounded-full">
                        ...
                        <h3 className="text-lg font-bold text-blue-900 mb-2">Video Tutorials</h3>
                        <p className="text-gray-500 text-sm">Watch expert video tutorials covering teaching techniques and lesson planning.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="how" className="py-20 px-6 bg-white">
                <div className="text-center mb-14">
                    <h2 className="text-3xl font-extrabold text-blue-900 mb-3">How It Works</h2>
                    <p className="text-gray-500">Getting started takes less than 5 minutes</p>
                </div>
                <div className="flex flex-col md:flex-row justify-center items-center gap-8 max-w-4xl mx-auto">
                    <div className="text-center flex-1">
                        <div className="w-16 h-16 bg-blue-900 text-white rounded-full flex items-center justify-center text-2xl font-extrabold mx-auto mb-4">1</div>
                        <h3 className="font-bold text-blue-900 text-lg mb-2">Create Your Account</h3>
                        <p className="text-gray-500 text-sm">Register with your details. Takes less than 2 minutes.</p>
                    </div>
                    <ChevronRight className="hidden md:block w-8 h-8 text-blue-300" />
                    <div className="text-center flex-1">
                        <div className="w-16 h-16 bg-blue-900 text-white rounded-full flex items-center justify-center text-2xl font-extrabold mx-auto mb-4">2</div>
                        <h3 className="font-bold text-blue-900 text-lg mb-2">Choose Your Package</h3>
                        <p className="text-gray-500 text-sm">Pick the plan that suits you and pay via EFT bank transfer.</p>
                    </div>
                    <ChevronRight className="hidden md:block w-8 h-8 text-blue-300" />
                    <div className="text-center flex-1">
                        <div className="w-16 h-16 bg-yellow-400 text-blue-900 rounded-full flex items-center justify-center text-2xl font-extrabold mx-auto mb-4">3</div>
                        <h3 className="font-bold text-blue-900 text-lg mb-2">Start Learning</h3>
            ...
            {/* OUR MISSION */}
            <section id="mission" className="py-20 px-6 bg-blue-900 text-white text-center">
                <p className="text-yellow-400 font-semibold text-sm uppercase tracking-widest mb-4">Our Mission</p>
                <h2 className="text-3xl font-extrabold mb-6">Why We Built TTG Academy</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-14">
                    <div className="bg-blue-800 rounded-2xl p-6">
                        ...
                        <h3 className="font-bold text-yellow-400 mb-2">Accessible</h3>
                        <p className="text-blue-300 text-sm">Affordable packages designed for South African students. No hidden fees. Pay via EFT.</p>
                    </div>
                    <div className="bg-blue-800 rounded-2xl p-6">
                        <div className="flex justify-center mb-3">
                            <LayoutList className="w-8 h-8 text-yellow-400" />
                        </div>
                        <h3 className="font-bold text-yellow-400 mb-2">Structured</h3>
                        <p className="text-blue-300 text-sm">Clear step by step lessons, assignments and final tests. You always know exactly where you are.</p>
                    </div>
                    <div className="bg-blue-800 rounded-2xl p-6">
                        <div className="flex justify-center mb-3">
                            <Globe className="w-8 h-8 text-yellow-400" />
                        </div>
                        <h3 className="font-bold text-yellow-400 mb-2">Global</h3>
                        <p className="text-blue-300 text-sm">Learn skills that let you work from anywhere in the world. Teach students from any country online.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="team" className="py-20 px-6 bg-gray-50">
                <div className="text-center mb-14">
                    <p className="text-yellow-500 font-semibold text-sm uppercase tracking-widest mb-2">The People Behind TTG</p>
                    <h2 className="text-3xl font-extrabold text-blue-900">Meet The Team</h2>
                </div>
                    ...
                    {teamMembers.map((member: TeamMember, index: number) => (
                        <div key={index} className="bg-white rounded-2xl shadow-md p-8 text-center hover:shadow-xl transition">
                            <div className="w-20 h-20 bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="text-3xl font-extrabold text-yellow-400">{member.initial}</span>
                            </div>
                            <h3 className="text-xl font-extrabold text-blue-900 mb-1">{member.name}</h3>
            ...
            <section className="bg-yellow-400 py-16 px-6 text-center">
                <h2 className="text-3xl font-extrabold text-blue-900 mb-4">Ready To Start Your Teaching Journey?</h2>
                <p className="text-blue-800 mb-8 text-lg">Join hundreds of students already learning with TTG Academy</p>
                <a href="/register" className="bg-blue-900 text-white font-bold px-10 py-4 rounded-full text-lg hover:bg-blue-800 transition shadow-lg">
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-xl font-bold">TTG <span className="text-yellow-400">Academy</span></h3>
                        </div>
